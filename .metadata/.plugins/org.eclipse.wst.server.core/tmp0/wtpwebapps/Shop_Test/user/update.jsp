			...
			<div class="container shop m-auto mb-5">
				<form action="update_pro.jsp" name="updateForm" method="post" >
					...
					<div class="input-group mb-3 row">
						<label class="input-group-text col-md-2" id="id">아이디</label>
					...
					<div class="input-group mb-3 row">
						<label class="input-group-text col-md-2"  id="name">이름</label>
						<input type="text" class="form-control col-md-10" 
					...
					<div class="input-group mb-3 row">
						...
						<div class="col-md-10 d-flex align-items-center">
							<div class="row">
								<div class="col">
									<input type="text" class="form-control" name="year" id="year" placeholder="출생년도 " size="6" 
										   value="<%= year %>">
								</div>
								...
								<div class="col">
									<input type="text" class="form-control" name="day" id="day" placeholder="일자" size="4" 
										   value="<%= day %>">
								</div>
							</div>
						</div>
					...
					<div class="input-group mb-3 row">
						<label class="input-group-text col-md-2" id="email">이메일</label>
						...
						<div class="row col-md-10 align-items-center">
							...
							<div class="col-4 px-0">
								<input type="hidden" name="tempEmail2" id="email2" value="<%= email2 %>" id="temp-email2">
					...
					<div class="input-group mb-3 row">
						<label class="input-group-text col-md-2" id="phone">전화번호</label>
						<input type="text" class="form-control col-md-10" 
					...
					<div class="input-group mb-3 row">
						<label class="input-group-text col-md-2" id="address">주소</label>
						<input type="text" class="form-control col-md-10" 
